...
$DIR/sshcontrol.py distribute --verbose --user user --config ./config.txt $DIR/captures/network_capture*
...
#$DIR/sshcontrol.py command --verbose --balance --user user --config ./config.txt "tshark -T fields -e ip.src -e dns.qry.name -Y 'dns.flags.response eq 0'"
